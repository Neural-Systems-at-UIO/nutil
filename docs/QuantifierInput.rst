 ...
 **While Nutil supports segmentations of any size - as long as there is enough memory installed on the computer, it is highly recommended to downscale the histological images before segmenting with ilastik. We do not recommend running Quantifier on segmented .png images larger than 10000x10000 pixels.**.. 
