...
**I performed analysis relative to the Allen CCFv3, but the coordinate output does not match the Allen CCFv3 coordinate system. What's going on?**
---------------------------------------------------------------------------------------------------------------------------------------------------
...
**I performed analysis relative to the WHS rat atlas, but the coordinate output does not match the WHS coordinate system. What going on?**
