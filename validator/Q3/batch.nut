type = Quantifier
name = WHS_artificial_dataset
analysis_type = QUINT
quantifier_input_dir = Q3/Input
quantifier_atlas_dir = Q3/Atlasmaps
label_file = WHS Atlas Rat v4
custom_label_file = 
xml_anchor_file = Q3/Atlasmaps/visuv09_test.json
quantifier_output_dir = Q3/Out
output_report = All
extraction_color = 0,1,20,255
object_splitting = No
object_min_size = 1
