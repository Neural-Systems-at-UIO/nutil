...
* Allen Mouse Brain Atlas, Common Coordinate Framework version 3 (CCFv3), delineations from 2015 and from 2017.
...
* Other atlases can be used in Nutil using the custom atlas feature as long as they are implemented in QuickNII and VisuAlign. To request integration of your atlas in QuickNII and VisuAlign, contact user support. 
